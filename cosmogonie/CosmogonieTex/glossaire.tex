...
\newEntity{Naos}{Naos}{Naos}{: grande étoile d'une lumière d'or. Elle signifie \textit{navire}. D'elle sortiront les \Ea}

%Dieux:

\newEntity{Ea}{Ea}{Eà}{: les êtres surgissant de l'étoile après que \Carac y dépose un fragment de \Drisst. Ils sont au nombre de 3: \Oros, \Nio et \Fercor}
...
\newEntity{Shuru}{Shuru}{Shuru}{: créEàre appelée par \Ogo, passa dans l'univers par la déchirure  d'\Auga. Libère \Ogo et après la réception d'un fragment de \Drisst il rebatit les imaginaires de \Mey appelé \Rdr}
